...
such as [Visual Studio](https://visualstudio.microsoft.com/vs/). An IDE provides
...
It depends on your personal preference. Try multiple and see which one you like
best.
...
install editing software like VSCode. If you don't know how to exit, have a look
at [this](https://stackoverflow.com/questions/11828270) link.
...
<Resources>
	<Resource title="Sublime Text 4" url="https://www.sublimetext.com/" starred>
...
- I compile and run using Terminal rather than building from within sublime
  text.
...
_Linters_ highlight compilation errors and warnings. The latter of the packages
below is faster and provides many features in addition to linting, though it
only supports `clang`
([discussion](https://forum.sublimetext.com/t/sublime-linter/62435/2)).

- [Sublime Linter (GCC)](https://packagecontrol.io/packages/SublimeLinter-gcc)

  - To customize compilation flags, open `Preferences: SublimeLinter Settings`
  ...
  - Example settings:
    ...
    {
        "linters": {
            "g++": { // https://packagecontrol.io/packages/SublimeLinter-gcc
                "disable": false,
                "executable": ["g++-11"],
                "args": ["-DLOCAL", "-std=c++17", "-O2", "-Wall", "-Wextra", "-Wshadow", "-Wconversion", "-Wfloat-equal", "-Wduplicated-cond", "-Wlogical-op"],
                "I": [],
                "excludes": [],
            },
        },
    ...
    ![sublime](running-code-img/sublimelinter-ex.png)

- [LSP](https://packagecontrol.io/packages/LSP)

  - Follow the instructions
    [here](https://lsp.sublimetext.io/guides/cplusplus/#clangd).
  ...
  - Example `compile_flags.txt`:
    ...
    ![sublime](running-code-img/lsp-ex.png)

  - You can see Neal Wu using this package
    [here](https://youtu.be/wh3pz18qC70?t=98).
...
<Resources>
	<Resource
		...
		url="https://stackoverflow.com/questions/31816095"
		starred
	>
	...
	<Resource
		...
		url="https://stackoverflow.com/questions/25337300"
	/>
</Resources>
