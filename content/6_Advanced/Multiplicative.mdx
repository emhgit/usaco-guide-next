...
$$
\phi(n) = \sum_{i=1}^n \varphi(i) = \sum_{i=1}^n i - \sum_{d \mid i, d < i} \varphi(d) = \frac{n(n+1)}{2} - \sum_{i=2}^n \sum_{d \mid i, d < i} \varphi(d) = \frac{n(n+1)}{2} - \sum_{i=2}^{n} \phi\left(\left\lfloor \tfrac{n}{i} \right\rfloor\right)
$$
