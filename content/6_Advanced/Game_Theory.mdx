...
<Resources>
    ...
    />
    <Resource source="CPH" title="25 - Game Theory" />
	<Resource
		source="Youtube"
		title="Sprague-Grundy-Theorem"
		url="https://www.youtube.com/watch?v=GRlGknQEOW8"
	/>
	<Resource source="Wikipedia" title="Sprague–Grundy theorem" url="https://en.wikipedia.org/wiki/Sprague%E2%80%93Grundy_theorem">includes formal definition and proof of the theorem</Resource>
</Resources>
...
The current xor-sum of the state is $x_1 \oplus x_2 \oplus \dots x_n=0$. Notice
...
What the Sprague-Grundy theorem
...
$$
n([p_1, \dots, p_n])=\bigoplus_{i=1}^n n(p_i)
$$
